            ...
            <div className="p-6 text-gray-900 max-w-4xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button onClick={addItem} className="text-slate-600 hover:text-slate-800 text-sm flex items-center gap-1 font-medium">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            className="flex-1 bg-transparent border-b border-gray-200 focus:border-slate-500 outline-none p-1 text-gray-900 font-medium placeholder-gray-400"
                                        />
        ...
        <div className="p-8 h-screen overflow-y-auto bg-gray-50">
            <div className="flex justify-between items-center mb-8">
                ...
                <button
                    ...
                    className="bg-slate-600 hover:bg-slate-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-all shadow-md hover:shadow-lg shadow-slate-600/20"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {templates.map(template => (
                    <div key={template.id} className="bg-white hover:bg-gray-50 border border-gray-200 hover:border-slate-400 hover:shadow-md rounded-xl p-6 transition-all group cursor-pointer relative shadow-sm" onClick={() => handleEdit(template)}>
                        ...
                        <div className="w-12 h-12 rounded-lg bg-slate-100 flex items-center justify-center text-slate-600 mb-4 group-hover:scale-105 transition-transform">
                            <Folder size={24} />
                        </div>
