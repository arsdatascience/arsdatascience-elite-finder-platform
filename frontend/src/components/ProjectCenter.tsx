        ...
        <div className="h-full flex flex-col bg-gray-50 text-gray-900 overflow-hidden">
            ...
            <div className="px-8 py-6 flex justify-between items-center bg-white border-b border-gray-200 sticky top-0 z-10">
                ...
                <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg flex items-center gap-2 shadow-sm transition-all hover:shadow-md font-medium"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {filteredProjects.map((project) => (
                        <div
                            ...
                            className="group bg-white rounded-xl border border-gray-200 p-5 hover:border-blue-400 hover:shadow-lg transition-all cursor-pointer flex flex-col"
                        >
