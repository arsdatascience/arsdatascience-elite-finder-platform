      ...
      <div className="flex gap-2 overflow-x-auto pb-2">
          <button 
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap ${
                platformFilter === 'all' ? 'bg-gray-800 text-white' : 'bg-white border border-gray-300 text-gray-600 hover:bg-gray-50'
            }`}
          >
              Todas
          </button>
          <button 
             ...
             className={`px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                platformFilter === 'google' ? 'bg-blue-100 text-blue-700 border-blue-200 border' : 'bg-white border border-gray-300 text-gray-600 hover:bg-gray-50'
            }`}
          >
          ...
          <button 
             ...
             className={`px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                platformFilter === 'meta' ? 'bg-purple-100 text-purple-700 border-purple-200 border' : 'bg-white border border-gray-300 text-gray-600 hover:bg-gray-50'
            }`}
          >
