...
export const WhatsAppSimulator: React.FC = () => {
    const [messages, setMessages] = useState<Message[]>([
        ...
        { id: '2', content: 'Olá! Claro, sou o assistente virtual da Elite. Temos planos a partir de R$ 99,90. Qual o tamanho da sua empresa?', role: 'assistant', timestamp: '10:31', status: 'read', type: 'text' },
        { id: '3', content: 'Somos uma startup com 15 funcionários.', role: 'user', timestamp: '10:32', status: 'read', type: 'text' },
    ]);
