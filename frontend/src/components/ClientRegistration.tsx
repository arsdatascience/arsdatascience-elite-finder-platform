...
import { User, MapPin, Phone, Mail, Save, X, Check, Building2, Globe, Calendar, AlertTriangle } from 'lucide-react';
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold relative">
                                                            ...
                                                            {risk && (
                                                                <div className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full p-0.5 border-2 border-white" title={`Risco de Churn: ${risk.riskLevel}`}>
