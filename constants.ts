...
import { LayoutDashboard, Megaphone, Plane, MessageSquare, Settings, Share2, GitBranch, BookOpen, Sparkles, Users, FileText, Bot } from 'lucide-react';
...
// Dados para Funil Comparativo Moderno
...
export const DEVICE_DATA = [
  { name: 'Mobile', value: 65, color: '#f43f5e' }, // Pink for Mobile
  { name: 'Desktop', value: 30, color: '#3b82f6' }, // Blue for Desktop
  { name: 'Tablet', value: 5, color: '#10b981' },   // Green for Tablet
];